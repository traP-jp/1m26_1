...
export interface components {
    schemas: {
        ...
        /** @description タイムラインに並ぶ投稿 1 件。traQ を都度引き直さずに描画できるよう、本文と (ユーザー, スタンプ) 単位のスタンプ全件まで含めて返す。 */
        TimelineMessage: {
            id: components["schemas"]["UUID"];
            userId: components["schemas"]["UserId"];
        ...
        /** @enum {string} */
        WebSocketEventType: "Initialized" | "MessageCreated" | "MessageDeleted" | "MessageEdited" | "StampUpdated" | "UsernameChanged" | "UserIconReplaced" | "StampInfoChanged" | "StampImageReplaced" | "CountReachingThreshold";
        /** @description 送信される WebSocket イベント。 */
        UserWebSocketEvent: components["schemas"]["InitializedEvent"] | components["schemas"]["MessageCreatedEvent"] | components["schemas"]["MessageDeletedEvent"] | components["schemas"]["MessageEditedEvent"] | components["schemas"]["StampUpdatedEvent"] | components["schemas"]["UsernameChangedEvent"] | components["schemas"]["UserIconReplacedEvent"] | components["schemas"]["StampInfoChangedEvent"] | components["schemas"]["StampImageReplacedEvent"] | components["schemas"]["CountReachingThresholdEvent"];
        WebSocketEventBase: {
        ...
        /** @description メッセージに対する (ユーザー, スタンプ) ごとの押下 1 件。 */
        Stamp: {
            stampId: components["schemas"]["UUID"];
            userId: components["schemas"]["UserId"];
